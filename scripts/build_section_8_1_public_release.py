...
SECTION_EIGHT_FOUR_PACKAGE_PATH = Path("content/chapter-8/section-8-4/package.json")
SECTION_EIGHT_FOUR_PACKAGE_ID = "chapter-8-section-8-4"
...
def section_eight_four_package() -> bytes:
    """Read the current generated Section 8.4 draft."""

    payload = (ROOT / SECTION_EIGHT_FOUR_PACKAGE_PATH).read_bytes()
    _validate_public_package(
        payload,
        "Section 8.4",
        SECTION_EIGHT_FOUR_PACKAGE_ID,
    )
    return payload
...
def _section_eight_four_page() -> str:
    return """<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
  ...
  <body>
    <main class="shell">
      ...
      <div class="version-grid">
        ...
        <section class="card">
          <p class="eyebrow">Section 8.4</p>
          <h2>Changes in Mechanical Energy for Nonconservative Forces</h2>
          <p>Open the generated, structurally validated 18-activity draft.</p>
          <a class="action version-link" href="section-8-4/">Open Section 8.4</a>
        </section>
        <section class="card">
...
def build(output: Path) -> None:
    ...
    packages = {
        ...
        Path("content/section-8-4/package.json"): section_eight_four_package(),
    ...
    files = {
        ...
        Path("section-8-4/index.html"): _section_eight_four_page().encode("utf-8"),
