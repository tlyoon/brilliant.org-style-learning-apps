...
`build_section_8_1_public_release.py` builds the minimal Chapter 8 static review site. It retains immutable and current Section 8.1 routes, adds the current Section 8.2, Section 8.3, and Section 8.5 drafts, and copies no manifests, review records, source files, run diagnostics, or development material.
